...
- **Thm 31.** Countable out-degree $\Rightarrow$ countable finite paths from a root; uncountable out-degree at the root $\Rightarrow$ uncountable one-step evolutions. Restriction on $R$, not a grain of $\mathrm{Obs}$. Extra. Not adopted. `papers/countable-outdegree.md`
