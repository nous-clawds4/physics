...
- **Thm 31.** Countable out-degree $\Rightarrow$ countable finite paths from a root; uncountable out-degree at the root $\Rightarrow$ uncountable one-step evolutions. $\mathrm{Path}(O_0)$ is finite walks. A countably branching tree still has a continuum of infinite rays; 2008 counting is finite walks. Restriction on $R$, not a grain of $\mathrm{Obs}$. Extra. Not adopted. `papers/countable-outdegree.md`
- **Thm 32.** Unique-successor $R$ $\Rightarrow$ no delayed fork from $O_0$; a delayed fork needs some reachable out-degree $\ge 2$. Restriction on $R$, not a grain of $\mathrm{Obs}$. Extra. Not adopted. (Proposition 14 is the formal-Fréchet fact.) `papers/branching-extra.md`
...
- **Measurable selection (named).** Borel (or universally measurable) map $s:\mathrm{Obs}\to\mathrm{Obs}$ with $(O,s(O))\in R$ on nonempty stars. Extra-on-extra, a function not the graph. Not a law of $R$. Not a grain. Not adopted. `papers/measurable-selection.md`
- **Irreflexivity of $R$ (named).** No self-loops. Extra, distinct from acyclicity. Not a grain. Not adopted. `papers/irreflexive-r.md`
- **Selection theorems (named).** KRN, JvN, Michael (closed *convex*-valued) extra-on-extra, not a law of $R$. Polish / standard Borel / paracompact-linear not invented. Not a grain. Not adopted. `papers/selection-theorems-extra.md`
- **Transitivity of $R$ (named).** Shortcuts. Extra, distinct from irreflexivity and acyclicity. Not a grain. Not adopted. `papers/transitive-r.md`
- **Asymmetry of $R$ (named).** No 2-cycles. Extra. Does not revive both-ways as lock-side. Irreflexive+transitive already implies asymmetric. Not a grain. Not adopted. `papers/asymmetric-r.md`
- **Totality of $R$ (named).** Every distinct pair comparable one way or the other. Extra. Tournament extra-on-extra. Does not force uncountable out-degree (pred can take the continuum). Tension with countable Path only after a further extra that puts a continuum into succ, not pred. Not a grain. Not adopted. `papers/total-r.md`
- **Antisymmetry of $R$ (named).** If both ways, then $O=O^\prime$. Extra. Distinct from asymmetry (self-loops allowed). On already-irreflexive $R$ equivalent to asymmetry, not a third independent extra. Not a grain. Not adopted. `papers/antisymmetric-r.md`
- **Well-foundedness of $R$ (named).** No infinite descending chain. Extra. Distinct from acyclicity and from finite $\mathrm{Anc}(q)$. Implies acyclicity; does not imply finite $\mathrm{Anc}$. Not a grain. Not adopted. `papers/well-founded-r.md`
- **Converse well-foundedness of $R$ (named).** No infinite ascending chain. Extra. Distinct from well-foundedness and from no-dead-ends/König. Not a grain. Not adopted. `papers/converse-well-founded-r.md`
